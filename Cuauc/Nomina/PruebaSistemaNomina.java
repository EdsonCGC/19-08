public class PruebaSistemaNomina {
    public static void main(String[] args) {
        EmpleadoAsalariado empleadoAsalariado = new EmpleadoAsalariado("Edson", "Gamboa", "1111", 800.00);
        EmpleadoPorHoras empleadoPorHoras = new EmpleadoPorHoras("Jaziel", "Gonzalez", "4444", 16.75, 40);
        EmpleadoPorComision empleadoPorComision = new EmpleadoPorComision("Chagoya", "Rodriguez", "9999", 10000, .06);
        EmpleadoBaseMasComision empleadoBaseMasComision = new EmpleadoBaseMasComision("Jhon", "Espejel", "1212", 5000, .04, 300);
...
//instancia de  (instancia de objeto )
            if (empleadoActual instanceof EmpleadoBaseMasComision) {
                ...
                System.out.printf("nuevo salario base con 10%% de aumento es: $%,.2f%n", empleado.obtenerSalarioBase());
            }
